...
public class TableModelStavke extends AbstractTableModel {
    ...
    private String[] kolone = {"Rb", "Pizza", "Količina", "Cena"};
    private int rb = 0;
...
//    private String[] kolone = {"Rb", "Pizza", "Kolicina", "Cena"};
    ...
    public void dodajStavku(StavkaRacuna sr) {
        ...
        for (StavkaRacuna stavkaRacuna : lista) {
            if (sr.getPizza().getPizzaID().equals(stavkaRacuna.getPizza().getPizzaID())) {
